...
const styles = StyleSheet.create({
  ...
  colorGreyDarkest: { color: '#3d4852' },
  colorGreyDarker: { color: '#606f7b' },
  colorGreyDark: { color: '#8795a1' },
  colorGrey: { color: '#b8c2cc' },
  colorGreyLight: { color: '#dae1e7' },
  colorGreyLighter: { color: '#f1f5f8' },
  colorGreyLightest: { color: '#f8fafc' },
